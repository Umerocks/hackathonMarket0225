...
const FAQS = () => {
  const FAQSs = [
    {
      id: 1,
      FAQS: "What types of furniture do you offer at Xpert Decors?",
      answer:
        "At Xpert Decors, we specialize in high-quality furniture including ergonomic chairs, stylish sofas, wooden chairs, wing chairs, desk chairs, and park benches. Our collection is designed to provide comfort, style, and durability.",
    },
    {
      id: 2,
      FAQS: "How can I place an order on Xpert Decors?",
      answer:
    ...
    },
    {
      ...
      answer:
        "Yes! Xpert Decors offers easy installment plans through partner financing services. You can choose a payment plan that suits your budget at checkout.",
    },
    {
      id: 7,
      FAQS: "How do I clean and maintain my Xpert Decors furniture?",
      answer:
    ...
    {
      id: 10,
      FAQS: "Is Xpert Decors available internationally?",
      answer:
