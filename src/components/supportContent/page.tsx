...
const SupportContent = ({ slug }: { slug: string }) => {
  const contentData: Record<string, { title: string; content: JSX.Element }> = {
    /** 🔹 Help & Support Page */
    "help-and-support": {
      title: "Help & Support | Xpert Decors Furniture Store",
      content: (
        <>
          <p className="text-gray-600 leading-relaxed">
            Looking for assistance with your furniture purchase? Welcome to
            Xpert Decors&apos;s <strong>Help & Support</strong> page. We provide quick
          ...
          <div className="bg-gray-100 p-4 rounded-lg shadow-md mt-3">
            <div className="grid md:grid-cols-3 gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                {/* KEY CHANGE: Added &apos; */}
                <span className="hover:text-second cursor-pointer">
                  123 Xpert Decors Lane&apos; FC 12345
                </span>
              </div>
            </div>
          </div>
    ...
    "terms-and-condition": {
      title: "Terms & Conditions | Xpert Decors Online Furniture Store",
      content: (
        <>
          <p className="text-gray-600 leading-relaxed">
            Welcome to Xpert Decors&apos;s <strong>Terms & Conditions</strong> page. By
          ...
          <ul className="list-disc ml-6 text-gray-700 space-y-2">
            ...
            <li>
              <strong>Liability Disclaimer:</strong> Xpert Decors is not responsible
    ...
    /** 🔹 Privacy Policy Page */
    "privacy-policy": {
      title: "Privacy Policy | Secure Online Shopping with Xpert Decors",
      content: (
        <>
          <p className="text-gray-600 leading-relaxed">
            At <strong>Xpert Decors</strong>, we prioritize your privacy and data
    ...
    /** 🔹 Help Center Page */
    help: {
      title: "Help Center | Xpert Decors Furniture Support",
      content: (
        <>
          <p className="text-gray-600 leading-relaxed">
